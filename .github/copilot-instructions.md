...
## Bucket Review Guidelines

When reviewing bucket definition, focus on the following points:

- Use of Latest Scoop Features
  - Consider using the latest features of Scoop, such as reusable workflows and composite actions.
  - Follow general Scoop best practices.
    - Ensure clarity and maintainability.
    - Ensure auto-update compatibility.
